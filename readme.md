...
Our [APIs](http://cocoadocs.org/docsets/SupportKit/1.1.1/) and [Support Center](https://supportkit.zendesk.com).
...
There are also other SKTSettings options you can customize. See our [API docs](http://cocoadocs.org/docsets/SupportKit/1.1.1/).
